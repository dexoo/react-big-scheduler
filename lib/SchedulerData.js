...
var SchedulerData = /*#__PURE__*/function () {
  function SchedulerData() {
    var date = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : (0, _moment["default"])().format(_index.DATE_FORMAT);
    ...
    this.localeMoment = _moment["default"];
    if (!!localeMoment) this.localeMoment = localeMoment;
    this.config = newConfig == undefined ? _config["default"] : _objectSpread(_objectSpread({}, _config["default"]), newConfig);
