...
var BodyView = /*#__PURE__*/function (_Component) {
    ...
    value: function render() {
      ...
      var tableRows = displayRenderData.map(function (item) {
        var rowCells = headers.map(function (header, index) {
          ...
          if (!!header.nonWorkingTime) style = _objectSpread(_objectSpread({}, style), {}, {
            backgroundColor: config.nonWorkingTimeBodyBgColor
          });
          if (item.groupOnly) style = _objectSpread(_objectSpread({}, style), {}, {
          ...
          if (!!behaviors.getNonAgendaViewBodyCellBgColorFunc) {
            ...
            if (!!cellBgColor) style = _objectSpread(_objectSpread({}, style), {}, {
...
_defineProperty(BodyView, "propTypes", {
